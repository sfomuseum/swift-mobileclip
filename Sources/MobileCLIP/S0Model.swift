    ...
    public init(_ models: URL? = nil) throws  {
        ...
        do {
            ...
            if models != nil {
                ...
                im_url.append(path: "mobileclip_s0_image.mlmodelc")
                txt_url.append(path: "mobileclip_s0_text.mlmodelc")
                
                image_model = try mobileclip_s0_image(contentsOf: im_url)
                text_model = try mobileclip_s0_text(contentsOf: txt_url)
